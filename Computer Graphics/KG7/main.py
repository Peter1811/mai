## Шандрюк Пётр Николаевич, группа М8О-308Б-20
## Вариант 11: В-сплайн, n = 5, k = 3
...
plt.ylim([0, 11])
plt.gcf().canvas.manager.set_window_title("Шандрюк Пётр Николаевич, группа М8О-308Б-20")
plt.title('B - Сплайн, n = 5, k = 3')
